...
// const apiKey = "pub_10553b3f4d4a1515c96566fba7af4c063dee6";
const apiKey = "pub_15543b3b3dcd5c68ada43faee498a4d1b38c2";
...
export function getData2() {
  return axios.get(
    `https://newsapi.org/v2/top-headlines?perPage=7&sources=bbc-news&apiKey=${apiKey}`,
    {}
  );
}
...
export function getSinglePageData(id) {
  console.log(id);
  return fetch(
    `https://newsdata.io/api/1/news?language=en&category=top&country=in&q=${id}&apiKey=${apiKey}`
  ).then((res) => res.json());
}
